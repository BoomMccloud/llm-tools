 ...
 *
 * Usage:
 *   npx tsx verify.ts find-file <filename>
 *   npx tsx verify.ts find-function <functionName> [--file <hint>]
 *   npx tsx verify.ts check-dependency <packageName>
 *   npx tsx verify.ts check-export <symbol> <file>
 *   npx tsx verify.ts check-signature <symbol> <file> [--expected <signature>]
 *   npx tsx verify.ts naming-convention [--sample-size <n>]
 *   npx tsx verify.ts analyze-types <file>
 */
...
Usage:
  npx tsx verify.ts <command> [options]
...
Examples:
  npx tsx verify.ts find-file src/services/UserService.ts
  npx tsx verify.ts find-function createUser --file src/services/UserService.ts
  npx tsx verify.ts check-dependency axios
  npx tsx verify.ts check-export UserService src/services/UserService.ts
  npx tsx verify.ts check-signature findById src/repositories/UserRepository.ts
  npx tsx verify.ts naming-convention --sample-size 50
  npx tsx verify.ts analyze-types src/models/User.ts
`);
}
